...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.WARNING('Creating 40 West Bengal infrastructure projects...'))
        ...
        self.stdout.write(self.style.SUCCESS('Successfully seeded 40 West Bengal infrastructure projects.'))
